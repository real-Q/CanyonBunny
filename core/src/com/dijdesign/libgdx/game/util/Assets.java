package com.dijdesign.libgdx.game.util;
...
public class Assets implements Disposable, AssetErrorListener {
	...
	public class AssetLevelDecoration {
		...
		public final AtlasRegion mountainsLeft;
		public final AtlasRegion mountainsRight;
		...
		public AssetLevelDecoration (TextureAtlas atlas) {
			...
			mountainsLeft = atlas.findRegion("mountain_left");
			mountainsRight = atlas.findRegion("mountain_right");
